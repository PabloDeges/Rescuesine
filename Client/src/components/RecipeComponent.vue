                ...
                <div class="layout_infobox">
                    <div class="info_bundle center">
                        <img src="../assets/user_icon.png"
                            class="userIconRecipe recipeShortInformation recipeIconInfos">
                        <p v-if="dish" class="textInformationRecipe recipeShortInformation">{{ dish.creator.name }}</p>
                        <p v-else class="title"></p>
                    </div>
                    <div class="info_bundle center">
                        <img src="../assets/price_icon.png"
                            class="priceIconRecipe recipeShortInformation recipeIconInfos">
                        <p v-if="dish" class="textInformationRecipe recipeShortInformation"> {{ dish.pricecategory }}€
                        </p>
                        <p v-else class="title"></p>
                    </div>
                    <div class="info_bundle center">
                        <img src="../assets/time_icon.png"
                            class="timeIconRecipe recipeShortInformation recipeIconInfos">
                        <p v-if="dish" class="textInformationRecipe recipeShortInformation">{{ dish.preparationtime
                            }}min</p>
                        <p v-else class="title"></p>
                    </div>
                </div>
